...
using namespace std;
void camguin(){
  TH1* h1 = getHistogram_h("mul", "asym_sam8", "hw_sum", "defaultCuts", "defaultHist");
  h1->Draw();
  //writeInt_leafHist_h( "evt", "bcm_an_ds3", "hw_sum", "1", "defaultHist");
  //writeMean_leafHist_h("evt", "bcm_an_ds3", "hw_sum", "1", "defaultHist");
  //writeRMS_leafHist_h( "evt", "bcm_an_ds3", "hw_sum", "1", "defaultHist");
  writeInt_leafHist_h( "evt", "bcm_an_ds3", "hw_sum", "defaultCuts", "defaultHist");
  writeMean_leafHist_h("evt", "bcm_an_ds3", "hw_sum", "defaultCuts", "defaultHist");
  writeRMS_leafHist_h( "evt", "bcm_an_ds3", "hw_sum", "defaultCuts", "defaultHist");
