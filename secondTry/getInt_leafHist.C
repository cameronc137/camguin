...
#include "camHist.hh"
using namespace std;
void getInt_leafHist(TString mode = "default", TString tree = "mul", TString branch = "asym_vqwk_04_0ch0", TString leaf = "hw_sum", Int_t runNumber = 0, Int_t nRuns = -1){
  ...
  TString  integral = "integral_"+channel;
