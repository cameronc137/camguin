...
TH1F *ht1 = new TH1F("ht1",Form("DR.rrawt2 && T6 triggered, Run %d",runnumber),130,1630,1760);
...
T->Draw("DR.rrawt2>>ht1","fEvtHdr.fEvtType==6","kRED");
